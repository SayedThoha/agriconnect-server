...
userRouter.get("/get_booking_details", (req, res) => bookedSlotController.getBookingDetails(req, res));
userRouter.get("/cancelSlot", (req, res) => userController.cancelSlot(req, res));
userRouter.get("/upcoming_appointment", (req, res) => bookedSlotController.upcomingAppointment(req, res));
userRouter.get("/getUpcomingSlot", (req, res) => bookedSlotController.getUpcomingSlot(req, res));
...
userRouter.get("/get_prescription_details", (req, res) => prescriptionController.getPrescriptionDetails(req, res));
userRouter.get("/notifications", (req, res) => notificationController.getNotificationsForUser(req, res));
userRouter.put("/notifications/mark-as-read", (req, res) => notificationController.markNotificationAsReadForUser(req, res));
userRouter.put("/notifications/clear", (req, res) => notificationController.clearNotificationsForUser(req, res));
