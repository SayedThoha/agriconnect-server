...
export interface IAdminController{
    ...
    searchUsers(req: Request<{}, {}, SearchUserRequest>,res: Response): Promise<void>;
    searchExperts(req: Request<{}, {}, SearchUserRequest>,res: Response): Promise<void>;
    toggleExpertStatus(req: Request, res: Response): Promise<void>;
    getKycData(req: Request, res: Response): Promise<void>;
    getExpertKycDetails(req: Request<{}, {}, {}, { expertId?: string }>,res: Response): Promise<void>;
    submitKycDetails(req: Request<{}, {}, KycUpdateData>,res: Response): Promise<void>;
    downloadKycDocuments(req:Request<{}, {}, {}, DownloadRequest>, res: Response): Promise<Response>;
